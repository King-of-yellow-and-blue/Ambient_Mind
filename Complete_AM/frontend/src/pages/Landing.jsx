      ...
      <div className="w-full text-white overflow-hidden noise bg-bg">
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full z-10 relative">
            ...
            <div className="lg:col-span-5 relative h-[400px] lg:h-[600px] w-full mt-12 lg:mt-0">
              {!isMobile ? (
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 rounded-full bg-gradient-to-hr from-primary to-secondary blur-[50px] animate-pulse-glow" />
                </div>
              )}
              
              {/* Floating UI Overlays */}
              <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }} className="absolute top-[10%] right-[0%] glass p-3 rounded-xl border-t border-primary/50 shadow-lg">
              ...
              <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, delay: 1, repeat: Infinity, ease: 'easeInOut' }} className="absolute bottom-[20%] left-[0%] glass p-3 rounded-xl border-l border-alert/50 shadow-lg">
                <div className="flex items-center space-x-2">
